...
class CalendarDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        if (savedTimestamp != null && savedTimestamp != "brak") {
            try {
                val sdf = java.text.SimpleDateFormat("dd.MM.yyyy EEEE, HH:mm", java.util.Locale.ENGLISH)
        ...
        confirmButton.setOnClickListener {
            ...
            val dayOfWeekFormat = java.text.SimpleDateFormat("EEEE", java.util.Locale.ENGLISH)
            ...
            sharedPreferences.edit().putString("timestamp", fullTimestamp).apply()
        ...
        background.setOnClickListener {
            // close fragment on background
            dismiss()
        }

        dialogContent.setOnClickListener {
            // DONT CHAGNE - block closing from clicking on content
        }
